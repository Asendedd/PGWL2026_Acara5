                    ...
                    <li class="nav-item me-2">
                        <a class="nav-link text-white d-flex align-items-center" href="{{ url('/table') }}">
                            ...
                            <svg class="me-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <path
                                    d="M5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-1 0v-9A.5.5 0 0 1 5 3zm5 0a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-1 0v-9A.5.5 0 0 1 10 3z" />
                                <path
                                    d="M3 5.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5z" />
                            </svg>
                            Table
                        </a>
                    </li>
